...
import seven from "../../../public/charatorImg/7.svg";
import Image from "next/image";
import exploreone from "../../../public/7explore1.svg";
import exploretwo from "../../../public/7explore2.svg";
import explorethree from "../../../public/7explore3.svg";

interface SevenProps {
  refSeven: React.RefObject<HTMLDivElement | null>;
}

const Seven = ({ refSeven }: SevenProps) => {
  return (
    <div
      id="seven"
      ref={refSeven}
